...
resource "metalcloud_infrastructure" "tenant1" {
  
  infrastructure_label = "tenant1-1"
                   ...
                   configs = [
                       {
                           ...
                           override_vlan_id      = 101
                        },
                       {
                           forced_subnet_pool_id = 9
                           override_vlan_id      = 201
                        },
                       {
                        ...
                        },
                       {
                           ...
                           override_vlan_id      = 401
                        },
                       {
                           forced_subnet_pool_id = 12
                           override_vlan_id      = 501
                        },
                    ]
                }
            )
